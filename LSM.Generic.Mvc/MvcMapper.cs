...
namespace LSM.Generic.Mvc
{
    ...
    public class MvcMapper
    {
        ...
        /// <returns></returns>
        public static List<SelectListItem> GetListOfSelectListItem<T>(dynamic List) where T : class
        {
            try
            {
        ...
        /// <returns></returns>
        public static List<SelectListItem> GetListOfSelectListItem<T>(dynamic List, object SelectedId ) where T : class
        {
            try
            {
                if (List is IEnumerable<T> || List is List<T>)
        ...
        /// <returns></returns>
        public static List<SelectListItem> GetListOfSelectListItem<T>(dynamic List, string Placeholder) where T : class
        {
            try
            {
                if (List is IEnumerable<T> || List is List<T>)
        ...
        /// <param name="Placeholder">If u want a first option(Placeholder) for the List</param>
        /// <returns></returns>
        public static List<SelectListItem> GetListOfSelectListItem<T>(dynamic List, object SelectedId , string Placeholder ) where T : class
        {
            try
            {
                if (List is IEnumerable<T> || List is List<T>)
